...
# Set up for two rows and two columns

      par(mfrow = c(2,2))

# Plot 1 - Upper Left

      plot(dataSet$dateTime, as.numeric(dataSet$Global_active_power), type = "l", ylab="Global Active Power (kilowatts)", xlab = "")

# Plot 2 - Upper Right

      plot(dataSet$dateTime, as.numeric(dataSet$Voltage), type = "l", ylab="Voltage", xlab = "datetime")
...
# Plot 4 - Lower Right
      ...
      plot(dataSet$dateTime, as.numeric(dataSet$Global_reactive_power), type = "l", ylab="Global_reactive_power", xlab = "datetime")
